        ...
        "prompts": {
            ...
            "profiles": {
                "Default": (
                    ...
                    "### CORE DIRECTIVE: EXTRACT ALL HIGHLIGHTS WITH SCORE >= 7\n"
                    "- Extract EVERY genuine highlight that meets Score 7 or higher (Score 7, 8, 9, 10). Do NOT artificially restrict good moments: if a stream has 15–30 funny or exciting moments, capture ALL of them!\n"
                    "- Score 7 is an ACTIVE, approved highlight (funny banter, good punchline, memorable laugh, single clutch kill, amusing mishap). You MUST extract Score 7 moments!\n"
                    "- STRICTLY AVOID CONTIGUOUS TILING: Do not slice the entire video into continuous end-to-end chunks (e.g. 30-45s, 45-58s, 58-75s). Filter out quiet looting, routine traveling, and mundane chit-chat (Scores 1–6). Each clip must be a distinct highlight with clear punchline or combat climax.\n\n"
                    ...
                    "- SMART TRIMMING: Start right where the setup question/premise is uttered (2–4s before the trigger). Do NOT include 30+ seconds of boring walking or unrelated chatter. Capture setup -> punchline -> climax laughter. End 2–3s after the laugh settles.\n"
                    ...
                    "- SMART TRIMMING: Start 3–5s before combat/action begins. Capture the FULL continuous sequence of action (do not chop a 3-kill streak into 3 separate clips). End 2–4s after the combat resolves, objective succeeds, or players react.\n\n"
                    ...
                    "- NO ADJACENT CHUNKING: If a moment ends, stop clipping. The next clip must be a completely separate peak event.\n"
                    ...
                    "### SCORING SYSTEM:\n"
                    "- Scores 1–6: Mundane gameplay, boring silence, flat casual talk, routine single kills -> STRICTLY IGNORE (Do NOT include in output).\n"
                    "- Score 7: Solid highlight (genuinely funny joke/banter, clever roast, clean clutch kill, memorable laugh) -> EXTRACT THIS!\n"
